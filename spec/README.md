...
| **Profile Source** *(planned)* | [profile-source.md](profile-source.md) | Pluggable source providers (file / http / postgres) for loading bundles + profiles at startup. AuthSource shared abstraction. |
